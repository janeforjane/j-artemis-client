...
public class SimpleProducerConsumer {
   ...
   public static void main(final String[] args) throws Exception {
      ...
      try {
         ...
         //it's here just for not to forget: how to do manual acknowledge
//            messageReceived.acknowledge(); //manual acknowledge BUT will acknowledge all messages in session
